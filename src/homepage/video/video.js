    ...
    <div className={style.page}>
      ...
      {window.innerWidth > 1200 && (
        <div className={style.arrows}>
          ...
          <figcaption className={style.que_pod}>
            Ответим на ваши вопросы
          </figcaption>

          <div
            onMouseEnter={() => {
              setAnimC(style.clock_anim);
            }}
            onMouseLeave={() => {
              setAnimC("");
            }}
          ...
          <figcaption className={style.clock_pod}>
            Подберем оптимальное время работы на студии, исходя из ваших задач
          </figcaption>

          <div
            onMouseEnter={() => {
              setAnimDtC(style.dt_clocks_anim);
              setAnimDt(style.dt_block_anim);
            }}
            onMouseLeave={() => {
              setAnimDtC("");
              setAnimDt("");
          ...
          <figcaption className={style.datetime_pod}>
            Выберем удобные для вас Дату и Время для посещения студии
          </figcaption>

          <div
            onMouseEnter={() => {
              setAnimW(style.changered);
            }}
            onMouseLeave={() => {
              setAnimW("");
            }}
          ...
          <figcaption className={style.changer_pod}>
            Будет ждать вас в выбранный день и час
          </figcaption>
        </div>
      )}
    </div>
