    ...
    <div className={style.page}>
      ...
      <div className={style.blocks}>
        ...
        <div className={style.text}>
          ...
          <h2 className={style.second_text}>
            Некоторые из них Вы могли видеть в Топ чартах, или слышать на радио.
            Наша команда звукорежиссеров поможет Вам реализовать ваши идеи в
            рамках любого музыкального направления
          </h2>
          <h2 className={style.second_text}>
            Некоторые из них Вы могли видеть в Топ чартах, или слышать на радио.
            Наша команда звукорежиссеров поможет Вам реализовать ваши идеи в
